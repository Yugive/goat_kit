...
var CmdClient = &cobra.Command{
	...
	Long:  "Generate the proto client code. Example: goat proto client helloworld.proto",
	Run:   run,
}
...
func init() {
	if protoPath = os.Getenv("GOAT_PROTO_PATH"); protoPath == "" {
...
func generate(proto string, args []string) error {
	...
	inputExt := []string{
		"--proto_path=" + base.GoatMod(),
		"--proto_path=" + filepath.Join(base.GoatMod(), "third_party"),
